...
3. Tap "Pair device with pairing code" in "Wireless debugging"<br><img :src="$withBase('/images/start_pairing.png')" stadb shell sh /storage/emulated/0/Android/data/moe.shizuku.privileged.api/start.sh
4. yle="max-width:320px;width:100%">
